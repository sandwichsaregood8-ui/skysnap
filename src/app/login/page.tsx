                    ...
                    <div className="space-y-5">
                        <div className="space-y-2 group">
                            ...
                            <div className="relative rounded-xl border border-outline-variant/20">
                                ...
                                <input onChange={(e) => setEmail(e.target.value)} value={email} required className="w-full bg-surface-container-lowest/30 border-0 rounded-xl py-3.5 pl-12 pr-4 text-on-surface placeholder:text-outline-variant/40 focus:ring-0 focus:outline-none transition-all duration-300" id="email" placeholder="name@company.com" type="email"/>
                            </div>
                        </div>
                        <div className="space-y-2 group">
                            ...
                            <div className="relative rounded-xl border border-outline-variant/20">
                                ...
                                <input onChange={(e) => setPassword(e.target.value)} value={password} required className="w-full bg-surface-container-lowest/30 border-0 rounded-xl py-3.5 pl-12 pr-12 text-on-surface placeholder:text-outline-variant/40 focus:ring-0 focus:outline-none transition-all duration-300" id="password" placeholder="••••••••" type={showPassword ? 'text' : 'password'}/>
