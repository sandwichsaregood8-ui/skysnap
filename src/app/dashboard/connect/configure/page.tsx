                ...
                <div className="glass-card rounded-[1.4rem] p-8 md:p-10 flex flex-col">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="pt-4 flex flex-col gap-6 items-center">
                            <button 
                                type="submit"
                                className="w-full bg-gradient-to-br from-primary to-primary-container text-on-primary-container font-headline font-extrabold py-4 rounded-xl shadow-[0_10px_20px_-5px_rgba(124,58,237,0.4)] active:scale-[0.98] transition-all uppercase tracking-wider text-sm disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
